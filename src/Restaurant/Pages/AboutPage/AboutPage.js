    ...
    return <Fragment>
        ...
        <div className={classes.AboutPage}>
            ...
            <div className={classes.SecondDiv}>
                <img  src='/Images/StorePhotoOne.jpg' className={classes.ImageOne}></img>
            ...
            <div className={classes.ThirdDiv}>
                ...
                <img  src='/Images/StorePhotoTwo.jpg' className={classes.ImageTwo}></img>
            </div>
            <div className={classes.SecondDiv}>
                <img  src='/Images/StorePhotoThree.jpg' className={classes.ImageOne}></img>
                <div className={classes.SecondDivWords}>
