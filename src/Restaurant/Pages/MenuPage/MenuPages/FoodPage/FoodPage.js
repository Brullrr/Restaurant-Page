...
const foodPage = (props) => {
    ...
    return (
        <Fragment>
            ...
            <MenuItem   Image={process.env.PUBLIC_URL + '/Images/ChickenWings.jpg'}
            ...
            <MenuItem   Image={process.env.PUBLIC_URL + '/Images/Pork.jpg'}
                        ...
                        Price='13.50'/>
            <MenuItem   Image={process.env.PUBLIC_URL + '/Images/Kimbap.jpg'}
                        ...
                        Price='14.50'/>
                        <div className={classes.Divider} />
            <MenuItem   Image={process.env.PUBLIC_URL + '/Images/Ramen.jpg'}
                        MenuItemName='Ramen' 
                        ...
                        Price='10.50'/>
                        <div className={classes.Divider} />
            <MenuItem   Image={process.env.PUBLIC_URL + '/Images/Fish.jpg'}
